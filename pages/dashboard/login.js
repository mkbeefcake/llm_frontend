    ...
    <div className="flex flex-col justify-center sm:py-12">
      <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
        ...
        <div className="panel shadow w-full rounded-lg divide-y divide-gray-200 px-5">
          ...
          <div className="py-5">
            <button type="button" className="mt-5 primary-button transition duration-200 focus:shadow-sm focus:ring-4 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block" onClick={onLogin}>
            ...
            <div className="grid grid-cols-2 gap-1">
              ...
              <div className="text-center sm:text-right whitespace-nowrap">
                <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg primary-color" onClick={onSignup}>
