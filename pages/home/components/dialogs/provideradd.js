          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              ...
              <div className="sm:flex sm:flex-row-reverse">
                <button
                  type="button"
                  className="primary-button w-full rounded-lg border border-transparent shadow-sm px-4 py-2 text-base font-medium sm:font-semibold text-white hover:bg-blue-700 sm:text-sm"
                  onClick={() => setShowAddProviderDialog(false)}
                >
                  Verify my account
                </button>
